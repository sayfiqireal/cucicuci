...
const runSeed = async () => {
    ...
    const userPassword = await (0, password_1.hashPassword)('password123');
    ...
    for (const data of ordersData) {
        const order = await prisma.order.create({
            data: {
                ...
                notes: data.notes,
                vehicleDetails: data.service.type !== 'karpet'
                    ? {
